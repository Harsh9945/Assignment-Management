        ...
        <Card className="shadow-lg border-slate-200">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <Input
              ...
              placeholder="e.g. student1@joineazy.edu or STU-001"
              required
            />
          ...
          <div className="mt-6 pt-5 border-t border-slate-100">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              <button
                type="button"
                onClick={() => fillCredentials('prof@joineazy.edu', 'admin123')}
              ...
              >
                ...
                <div>
                  <div className="font-semibold">Admin (Professor)</div>
                  <div className="text-[11px] text-purple-600">prof@joineazy.edu</div>
                </div>
              </button>

              <button
                type="button"
                onClick={() => fillCredentials('student1@joineazy.edu', 'student123')}
              ...
              >
                ...
                <div>
                  <div className="font-semibold">Student 1 (Owner)</div>
                  <div className="text-[11px] text-emerald-600">student1@joineazy.edu</div>
                </div>
              </button>

              <button
                type="button"
                onClick={() => fillCredentials('student4@joineazy.edu', 'student123')}
              ...
              >
                ...
                <div>
                  <div className="font-semibold">Student 4 (Pending Submission)</div>
                  <div className="text-[11px] text-amber-600">student4@joineazy.edu (Alpha Squad Member)</div>
                </div>
              </button>
            </div>
          </div>
